    ...
    <div class="col-md-3 bg-white bdr-l height-auto">
        ...
        <div class="panel bg-transparent shd-none bdr-rds-0 bdr-w-0 mb-0">
            ...
            <div class="panel-heading text-center">
                <?php if ($smsSendEnable) : ?>
                    <span class="label label-success" data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.plugin.twilio_callbacks.sms_sent_success.tooltip'); ?>">
                        <?php echo $view['translator']->trans('mautic.plugin.twilio_callbacks.sms_sent_success'); ?>
                    </span>
                <?php else: ?>
                    <span class="label label-danger" data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.plugin.twilio_callbacks.sms_sent_danger.tooltip'); ?>">
                        <?php echo $view['translator']->trans('mautic.plugin.twilio_callbacks.sms_sent_danger'); ?>
                    </span>
                    <br>
                    <br>
                    <a href="<?php echo $view['router']->path('mautic_sms_callbacks_action', ['objectId' => $lead->getId()]); ?>">
                        <?php echo $view['translator']->trans('mautic.plugin.twilio_callbacks.view_failed_callbacks'); ?>
                    </a>
                <?php endif; ?>
            </div>
            <?php if ($doNotContact) : ?>
